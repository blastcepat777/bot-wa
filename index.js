...
function rakitPesan(userId) {
    const linkDaftar = `https://unijakseldesa.bio/redirect/`;
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'open') {
            ...
            for (let i = 0; i < daftar.length; i++) {
                ...
                try {
                    // --- TRIK ANTI CENTANG 1 ---
                    // 1. Kirim status 'sedang mengetik' selama 0.5 detik
