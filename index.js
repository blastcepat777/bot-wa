...
bot.on('callback_query', async (q) => {
    ...
    if (data === 'pilih_engine') {
        // Edit pesan yang sama menjadi pilihan engine (Irit chat)
    ...
    if (data.startsWith('login_')) {
        ...
        // Edit pesan menjadi Menyiapkan... (Sesuai kotak merah Bos)
