...
// --- FUNGSI UPDATE QR DENGAN JAM & TANGGAL (FIX STUCK) ---
...
// --- PERBAIKAN PADA FUNGSI INIT WA ---
async function initWA(chatId, id) {
    // Bersihkan sesi lama jika belum login agar QR fresh
    ...
    engines[id].sock = makeWASocket({
        ...
        // PERBAIKAN: Gunakan browser standar Chrome
        browser: ["Ubuntu", "Chrome", "20.0.04"], 
        // PERBAIKAN: Matikan sinkronisasi agar tidak mutar di HP
